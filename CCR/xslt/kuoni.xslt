...
<xsl:stylesheet   xmlns:xsl="http://www.w3.org/1999/XSL/Transform"  xmlns:t="http://www.exchangefortravel.org" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="2.0" exclude-result-prefixes="t xsi">
  <!-- XML output! -->
  <xsl:output method="xml" indent="yes"  omit-xml-declaration = "yes" encoding="UTF-8" cdata-section-elements="t:Description"/> 
  <xsl:template match="/">
 		<Response>
 			<xsl:attribute name="Version">1.0</xsl:attribute>
 			
 			<xsl:apply-templates select="t:Transaction/t:Action" mode="copy"/>
