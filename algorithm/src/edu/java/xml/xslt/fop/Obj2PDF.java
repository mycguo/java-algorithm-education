...
public class Obj2PDF {
    ...
    public static void main(String[] args) {
        try {
            ...
            File xsltfile = new File(baseDir, "/src/edu/java/xml/xslt/fop/projectteam2fo.xsl");
            File pdffile = new File(baseDir, "/src/edu/java/xml/xslt/fop/ResultObj2PDF.pdf");
            ...
            Obj2PDF app = new Obj2PDF();
            app.convertProjectTeam2PDF(Obj2XML.createSampleProjectTeam(), xsltfile, pdffile);
