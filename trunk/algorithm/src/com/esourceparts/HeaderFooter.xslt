<?xml version="1.0" encoding="UTF-8" ?>
	...
	<xsl:output encoding="utf-8" />
      <xsl:template match="Header">
        <html>
          <head>
            <title><xsl:value-of select="/OnlineStore/Page/PageTitle" /></title>
            <meta http-equiv="Content-Type" content="text/html; charset=windows-1251" />
            <META NAME="Description">
              <xsl:attribute name="CONTENT">
                <xsl:value-of select="/OnlineStore/Page/MetaDescription" />
              </xsl:attribute>
            </META>
            <META NAME="keywords">
              <xsl:attribute name="CONTENT">
                <xsl:value-of select="/OnlineStore/Page/MetaKeywords" />
              </xsl:attribute>
            </META>
            <meta http-equiv="Content-Type" content="text/html; charset=windows-1251" />
            <script type="text/javascript" language="javascript" src="/Design/Templates/14/js/rollovers.js"></script>
	...
	<meta name='google-site-verification' content='Cfd3vuJoZn9HBXrxmfe6S6KErljI3WCEur-8lkokToo' />            
          <xsl:value-of select="/OnlineStore/Header/HeaderCodeElement" disable-output-escaping="yes" /></head>
...
<!--                              <img src="/Design/Templates/{/OnlineStore/@designDirectory}/images/spacer.gif" width="112" height="1" /> -->
                          ...
                          <tr>
                            <td><img src="/Design/Templates/common/images/i.gif" width="1" height="1" border="0" alt=""/></td>
                            <td style="height: 14px;background-color:transparent"><img src="/Design/Templates/common/images/i.gif" width="1" height="1" border="0" alt=""/>
...
<div align="center">
 <span id="siteseal"><script type="text/javascript" src="https://seal.godaddy.com/getSeal?sealID=VdjeMcXs2gfVvqJGbMYi63vk6BwU0acLEuSUECLYBJJSFGZAOOt13Is"></script><br/><a href='https://www.godaddy.com/gdshop/ssl/ssl.asp'>SSL Certificates</a></span>										  
										  
</div>            
            
          <xsl:if test="not(contains(/OnlineStore/@currentUrl, 'https://'))"><xsl:value-of select="/OnlineStore/Header/AnalyticsCodeElement" disable-output-escaping="yes"></xsl:value-of></xsl:if></body>
        </html>
      </xsl:template>
      <!-- templates -->
	...
	<xsl:with-param name="class">style1</xsl:with-param>
      ...
      <xsl:template name="AddToCartBlock">
        ...
        <td valign="middle" align="center">
          <img src="/Design/Templates/{/OnlineStore/@designDirectory}/images/marker.gif" width="10" height="9" hspace="7"
