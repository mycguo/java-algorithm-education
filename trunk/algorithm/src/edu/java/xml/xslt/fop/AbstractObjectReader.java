...
public abstract class AbstractObjectReader implements XMLReader {
    ...
    protected ProxyHandlerProxy handler;
    /** Error handler */
     ...
     * Set the handler to be the ProxyHandler, then the proxyHandler forward it to after processing
     */
    public void setContentHandler(ContentHandler handler) {
        this.orgHandler = handler;
        this.handler = new ProxyHandlerProxy(handler);
    }
