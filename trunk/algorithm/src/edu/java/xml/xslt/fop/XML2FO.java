...
public class XML2FO {
    ...
    public static void main(String[] args) {
        try {
            ...
            File xmlfile = new File(baseDir, "/src/edu/java/xml/xslt/fop/projectteam.xml");
            File xsltfile = new File(baseDir, "/src/edu/java/xml/xslt/fop/projectteam2fo.xsl");
            File fofile = new File(baseDir, "/src/edu/java/xml/xslt/fop/ResultXML2FO.fo");
