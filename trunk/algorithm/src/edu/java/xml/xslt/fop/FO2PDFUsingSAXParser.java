 ...
 */
public class FO2PDFUsingSAXParser {
    ...
    public static void main(String[] args) {
        try {
            ...
            File fofile = new File(baseDir, "/src/edu/java/xml/xslt/fop/helloworld.fo");
            File pdffile = new File(baseDir, "/src/edu/java/xml/xslt/fop/ResultFO2PDFUsingSAXParser.pdf");
            ...
            FO2PDFUsingSAXParser app = new FO2PDFUsingSAXParser();
