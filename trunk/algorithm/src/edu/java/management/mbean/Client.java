...
public class Client {
    ...
    public static void main(String[] args) {
		...
		new ObjectName(domain +":type=SimpleStandard,index=2");
            echo("\nCreate SimpleStandard MBean...");
            mbsc.createMBean("edu.java.management.mbean.SimpleStandard", stdMBeanName, null, null);
	    waitForEnterPressed();
		...
		new ObjectName(domain +":type=SimpleDynamic,index=2");
            echo("\nCreate SimpleDynamic MBean...");
            mbsc.createMBean("edu.java.management.mbean.SimpleDynamic", dynMBeanName, null, null);
	    waitForEnterPressed();
