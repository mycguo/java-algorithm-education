...
public class Server {
	...
	private static ObjectName createSimpleMBean(MBeanServer mbs,
		...
		try {
			...
			/*
			Object o;
			if (mbeanClassName.equalsIgnoreCase("SimpleStandard"))
				o = new SimpleStandard();
			else
				o = new SimpleDynamic();
			mbs.registerMBean(o, mbeanObjectName);
			*/
			mbs.createMBean("edu.java.management.mbean." + mbeanClassName, mbeanObjectName);
